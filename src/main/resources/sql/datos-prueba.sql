...
INSERT INTO users (id, username, email, password, roles) VALUES (1, 'John', 'john.doe@example.com', 'password123', 'USER'), (2, 'Jane', 'jane.smith@example.com', 'securepassword', 'ADMIN');
