...
INSERT INTO users (id, username, email, password, role) VALUES (1, 'John', 'john.doe@example.com', 'password123', 'CLIENT'), (2, 'Jane', 'jane.smith@example.com', 'securepassword', 'ADMIN');
